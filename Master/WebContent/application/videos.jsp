...
<%	Session sess = (Session) session.getAttribute("hb");
	...
	session.setAttribute("munuParaVideo", request.getParameter("pag"));
%> 
<html>
<head>
	...
	<script type="text/javascript" src="../js/comum/videos.js"></script>
...
<body>
	...
	<jsp:include page="../inc/menu.jsp">
		<jsp:param name="currentPage" value="<%= request.getParameter("pag") %>"/>
	</jsp:include>	
	<div id="centerAll">
		...
		<div id="formStyle">
			<form id="unit" method="get" onsubmit="return search()">
				<input type="hidden" name="menuIn" id="menuIn" value="<%= request.getParameter("pag") %>">
				
				<div id="geralDate" class="alignHeader" >
					<jsp:include page="../inc/feedback.jsp">
						<jsp:param name="currPage" value="Tutoriais"/>			
					</jsp:include>
					<div class="topContent">						
						<div id="referencia" class="textBox" style="width: 300px; margin-left: 250px;">
				...
				<div id="mainContent">
					...
					<div id="dataGrid">
						<%						
						Query query = sess.createQuery("from Video as v where v.menu = :menu order by v.titulo");
						query.setString("menu", request.getParameter("pag").toString());
						...
						DataGrid dataGrid= new DataGrid("video_view.jsp");						
