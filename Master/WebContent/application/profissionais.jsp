			...
			<form id="unit" method="get" onsubmit="return search()">
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">
						...
						<div id="cpf" class="textBox" style="width: 110px">
							<label>Cpf</label><br/>
							<input id="cpfIn" name="cpfIn" type="text" style="width: 110px" onkeydown="mask(this, cpf);"/>
						</div>
						<div id="conselho" class="textBox" style="width: 135px;">
							<label>Nro. Conselho</label><br/>
							<input id="conselhoIn" name="conselhoIn" type="text" style="width: 135px;" class="required"/>
						</div>
