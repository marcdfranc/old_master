...
<head>
	...
	<title>Master Boderô de Mensalidades de Empresa</title>
</head>
<body>
			...
			<form id="unit" method="post" action="../CadastroPosicao">
				<div id="geralDate" class="alignHeader">
					...
					<div id="abaMenu">
						...
						<div class="sectedAba2">
							<label>Borderô de Mensalidades</label>
						</div>
						<div class="sectedAba2">
							<label>></label>
						</div>
				...
				<div id="mainContent">				
					<div id="dataGrid" style="" >
						<div id="centerGrid">
							<div id="counter"></div>
							<%query = sess.getNamedQuery("mensalidadeEmpresa");
							...
							for(Mensalidade mensalidade: mensalidadeList) {
								...
								dataGrid.addData(Util.zeroToLeft(mensalidade.getUsuario().getContrato().getCtr(), 4));
							...
							dataGrid.addTotalizador("Renovações", String.valueOf(countRenovacao), "totalRenov", true);
							dataGrid.addTotalizador("Mensalidades", String.valueOf(countMensalidade), "totalMensal", true);
							dataGrid.addTotalizador("Adesões", String.valueOf(countAdesao), "totalAdes", false);
