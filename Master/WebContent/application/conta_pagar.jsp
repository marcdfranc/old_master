...
<head>
	...
	<script type="text/javascript" src="../js/comum/contas_pagar.js" ></script>
	...
	%>
	<title>Master Contas a Pagar</title>
</head>
<body onload="load()">
			...
			<form id="unit" method="get" onsubmit="return search()">
				<div id="geralDate" class="alignHeader" >
					<jsp:include page="../inc/feedback.jsp">
						<jsp:param name="currPage" value="Contas a Pagar"/>			
					</jsp:include>
				...
				<div id="mainContent">
					...
					<div id="dataGrid">
						...
						if (session.getAttribute("perfil").toString().equals("a")
								|| session.getAttribute("perfil").toString().equals("d")){
							query= sess.createQuery("from Lancamento as l where l.tipo = 'd' " +
									" and l.status = 'a' " +  
