...
<head>
	...
	<script type="text/javascript" src="../js/comum/lancamento_empresa_tratamento.js" ></script>
</head>
<body>
			...
			<form id="formEmpresa" method="get" onsubmit="return search();" >
				...
				<div id="geralDate" class="alignHeader" >
					...
					<div id="abaMenu">
						...
						<div class="aba2">
							<a href="lancamento_empresa_mensalidade.jsp">Borderom de Mensalidades</a>
						</div>					
						<div class="sectedAba2">
							<label>></label>	
						</div>						
						<div class="sectedAba2">
							<label>Bordero de Tratamentos</label>
						</div>						
					</div>
				...
				<div id="mainContent">										
					...
					<div id="dataGrid">
						<%query = sess.getNamedQuery("parcelaEmp");
						...
						for(ParcelaOrcamento parcela: parcelaList) {
							...
							dataGrid.addData(String.valueOf(parcela.getId().getOrcamento().getUsuario().getContrato().getCodigo()));
					...
					<div class="totalizador">
						...
						<label id="labelTotal" class="titleCounter">Número de Tratamentos: <%=gridLines%> - Valor Total:</label>
					</div>
				</div>
			</form>
		</div>
