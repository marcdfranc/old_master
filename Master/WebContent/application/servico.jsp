				...
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">					
						<div id="codigo" class="textBox" style="width: 70px;">
							...
							<input id="codigoIn" name="codigoIn" type="text" style="width: 70px;" class="required" onblur="genericValid(this);" />
						</div>						
				...
				<div id="mainContent">										
					...
					<div id="dataGrid" >
						...
						for(Servico serv: servico) {
							...
							} else if (serv.getEspecialidade().getSetor().equals("a")){
								dataGrid.addData("Administrativa");
							} else if (serv.getEspecialidade().getSetor().equals("e")){
