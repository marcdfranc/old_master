...
<head>
	...
	<script type="text/javascript" src="../js/comum/bordero_profissional.js" ></script>
	...
	<div id="centerAll">
		...
		<div id="formStyle">
			<form id="parc" method="get" onsubmit="return search()">
				<div>
					<input type="hidden" id="profissionalId" name="profissionalId" value="<%= profissional.getCodigo() %>" />
				...
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">
						<div class="textBox" id="unidadeRef" name="unidadeRef" style="width: 75px;">
							...
							<input id="unidadeRefIn" name="unidadeRefIn" type="text" style="width:75px" readonly="readonly" value="<%=profissional.getUnidade().getReferencia()%>"/>
						</div>
						<div id="unidade" class="textBox" style="width: 330px;" >
							<label>Unidade</label><br/>
							<input id="unidadeIn" name="unidadeIn" type="text" style="width: 330px;" value="<%= Util.initCap(profissional.getUnidade().getFantasia()) %>" readonly="readonly" />
						</div>
						...
						<div id="profissional" class="textBox" style="width: 280px;" >
							...
							<input id="profissionalIn" name="profissionalIn" type="text" style="width: 280px;" value="<%=Util.initCap(profissional.getNome())%>" readonly="readonly" />
						</div>
						<div id="conselho" class="textBox" style="width: 125px;" >
							<label>Nro. Conselho</label><br/>
							<input id="conselhoIn" name="conselhoIn" type="text" style="width: 125px;" value="<%=profissional.getConselho().toUpperCase()%>" readonly="readonly" />
						</div>
					</div>
				</div>
				<div id="mainContent">
					<div id="dataGrid">
						<%query = sess.getNamedQuery("pagProfissionalAll");
						query.setLong("profissional", Long.valueOf(request.getParameter("id")));				
					...
					<div id="somador">
						<%for(int i=0 ; i < gridValues.size(); i++) {
							...
							<%} else {%>
								<input id="<%= "gridValue" + i %>" name="<%= "gridValue" + i %>" type="hidden"  value="0"/>
							<%}						
						}%>
					</div>
				</div>
