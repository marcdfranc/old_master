				...
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">					
						<div id="codigo" class="textBox" style="width: 80px;">
							...
							<input id="codigoIn" name="codigoIn" type="text" style="width: 80px;" class="required" />
						</div>						
						<div id="descricao" class="textBox" style="width: 250px;">
							<label>Descrição</label><br/>
							<input id="descricaoIn" name="descricaoIn" type="text" style="width: 250px;" class="required" enable="false"  />
						</div>
						<div id="setor" class="textBox" style="width: 105px">
							<label>Atividade</label><br/>
							<select type="select-multiple" id="setorIn" name="setorIn" class="required" >
