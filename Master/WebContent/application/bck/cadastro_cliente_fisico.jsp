			...
			<form id="formPost" method="post" action="../CadastroClienteFisico" onsubmit= "return getCampos(this, true)">
					...
					<div class="topButtonContent">
						<%if (relId != null) {%>
							<div class="formGreenButton">
								<input class="greenButtonStyle" type="button" value="Cadastro" onclick="emitContrato()" />
							</div>
						<%} %>
						<div class="formGreenButton">
				...
				<div id="mainContent">
					<div id="dadosPessoais" class="bigBox" >
						...
						<div id="pai" class="textBox" style="width: 280px;">
							<label>Pai</label><br/>
							<input id="paiIn" name="paiIn" type="text" style="width: 280px;" value="<%=(isEdition && !usuario.getPai().trim().isEmpty())? Util.initCap(usuario.getPai()): "" %>" onblur="genericValid(this);" />
						</div>
						<div id="mae" class="textBox" style="width: 280px;">
							<label>mãe</label><br/>
							<input id="maeIn" name="maeIn" type="text" style="width: 280px;" value="<%=(isEdition && !usuario.getMae().trim().isEmpty())? Util.initCap(usuario.getMae()): "" %>" onblur="genericValid(this);" />
						</div>
					</div>
					<div id="endereco" class="bigBox">
						...
						<div id="rua" class="textBox" style="width: 247px">
							...
							<input id="ruaIn" name="ruaIn" type="text" style="width: 247px" value="<%=(isEdition)? Util.initCap(endereco.getRuaAv()): "" %>" class="required" onblur="genericValid(this)" />
						</div>
						...
						<div id="bairro" class="textBox" style="width: 225px">
							...
							<input id="bairroIn" name="bairroIn" type="text" style="width: 225px" value="<%=(isEdition && endereco.getBairro() != null)? Util.initCap(endereco.getBairro()): "" %>" />
						</div>
					...
					<div id="situacaoFinanceira" class="bigBox" style="bottom: 30px !important" >
						...
						<div id="adesao" class="textBox" style="width: 95px;">
							<label>Adesão</label><br/>
							<input id="adesaoIn" name="adesaoIn" type="text" style="width: 95px;" value="0.00" onkeydown="mask(this, decimalNumber);" class="required" onblur="genericValid(this);" />
						</div>												
						<div id="parcela" class="textBox" style="width: 95px;">
							<label>Mensalidade</label><br/>
							<input id="parcelaIn" name="parcelaIn" type="text" style="width: 95px;" value="0.00" onkeydown="mask(this, decimalNumber);" class="required" onblur="genericValid(this);" />
						</div>
						<div class="textBox">
