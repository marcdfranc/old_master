				...
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">
						...
						<div id="descricao" class="textBox" style="width: 270px;">
							...
							<input id="descricaoIn" name="descricaoIn" type="text" style="width: 270px;" value="<%=(isEdition)? Util.initCap(servico.getDescricao()): "" %>" class="required" enable="false" onblur="genericValid(this);" />
						</div>
					</div>
				</div>
				<div id="mainContent">
