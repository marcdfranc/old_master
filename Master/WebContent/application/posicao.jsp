...
<head>
	...
	<script type="text/javascript" src="../js/comum/posicao.js" ></script>
					...
					<div id="dataGrid">
						<div id="centerGrid" style="min-height: 100px; margin-left: 193px; width: 350px">
							...
							<%
								...
								Query query= sess.createQuery("from Posicao as p order by p.codigo");
								...
								for(Posicao pos: posicao) {
									...
									dataGrid.addData(Util.initCap(pos.getDescricao()));
									dataGrid.addRow();
								}
						...
						<div id="pagerGrid" class="pagerGrid" style="width: 500px; margin-right: 320px; margin-bottom: 30px"></div>						
					</div>
				</div>							
			</form>			
		</div>
