...
<head>
	...
	<script type="text/javascript" src="../js/comum/agenda_pessoal.js"></script>
	...
	<div id="windowAgenda" class="removeBorda" title="Evento" style="display: none;">
		<form id="formGrupo" onsubmit="return false;">
			<fieldset>
				...
				<label for="diaTodo">O Dia Todo</label><input type="checkbox" id="diaTodo" name="diaTodo"/>
			</fieldset>
		</form>
	</div>
			...
			<form id="formPost" name="formPost" method="post" action="../CadastroTabelaFranchising"  onsubmit= "return validForm(this)" >
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">
						<div class="indexTitle">
							...
							<h4 style="margin-left: 150px">Seja bem vindo a sua Agenda Pessoal.</h4>
				...
				<div class="topButtonContent">					
					<div class="formGreenButton">
						<input class="greenButtonStyle" onclick="imprimeAgenda();" type="button" value="Imprimir"/>
					</div>
				</div>
				<div id="mainContent">
