...
<%@page import="com.marcsoftware.utilities.Util"%><html xmlns="http://www.w3.org/1999/xhtml">
	<%!Query query; %>
	<%!Session sess; %>
	<%! List<PrestadorServico> prestadorList; %>
...
<head>
	...
	<script type="text/javascript" src="../js/comum/prestador_servico.js" ></script>	
	<script type="text/javascript" src="../js/lib/componentes/msf_windows.js"></script>
	
	<title>Master - Prestador de Serviços</title>
</head>
<body onload="load()">
			...
			<form id="unit" method="get" onsubmit="return search();" >
				...
				<div id="geralDate" class="alignHeader" >
					...
					<div class="topContent">
						...
						<div id="nome" class="textBox" style="width: 300px;">
							<label>Nome do Prestador de Serviços</label><br/>
							<input id="nomeIn" name="nomeIn" type="text" style="width: 300px;"/>
						</div>
				...
				<div id="mainContent">										
					...
					<div id="dataGrid">						
						...
						if (session.getAttribute("perfil").toString().equals("a")
							...
							query= sess.createQuery("from PrestadorServico as p order by p.codigo");							
						} else {
							query= sess.createQuery("from PrestadorServico as p where p.unidade.codigo = :unidade order by p.codigo");
						...
						dataGrid.addColumWithOrder("5", "Ref.", true);
						dataGrid.addColumWithOrder("27", "Nome", false);						
						dataGrid.addColumWithOrder("32", "Ramo", false);
						dataGrid.addColumWithOrder("18", "Cpf", false);
						dataGrid.addColum("18", "Fone");
						for(PrestadorServico prestador: prestadorList) {						
							query = sess.getNamedQuery("informacaoPrincipal");
							query.setEntity("pessoa", prestador);
							query.setFirstResult(0);
							query.setMaxResults(1);
							informacao = (Informacao) query.uniqueResult();
							dataGrid.setId(String.valueOf(prestador.getCodigo()));
							dataGrid.addData(String.valueOf(prestador.getCodigo()));
							dataGrid.addData(Util.initCap(prestador.getNome()));
							
							dataGrid.addData(Util.initCap(prestador.getRamo().getDescricao()));
							dataGrid.addData(Util.mountCpf(prestador.getCpf()));
