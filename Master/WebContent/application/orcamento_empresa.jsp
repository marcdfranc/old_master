...
<%@page import="com.marcsoftware.utilities.Util"%><html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%!List<EmpresaSaude> empresaList= null; %>
	...
	query.setLong("unidade", (unidadeList.size() == 1)? unidadeList.get(0).getCodigo() : 0);
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
	<title>Master Orçamento Empresa Saúde</title>
	
	<script type="text/javascript" src="../js/jquery/jquery.js"></script>
	<script type="text/javascript" src="../js/jquery/interface.js"></script>
	<script type="text/javascript" src="../js/lib/new_datagrid.js"></script>	
	<script type="text/javascript" src="../js/comum/orcamento_empresa.js" ></script>
			...
			<form id="orc" method="get" onsubmit="return search()" >				
				<div id="geralDate" class="alignHeader" >
					...
					<%if (usuario != null) {%>
						<div id="abaMenu">
							...
							<div class="sectedAba2">
								<label>Orçamentos de Empresas</label>
							</div>
							<div class="sectedAba2">
								<label>></label>	
							</div>
					...
					<%} else {%>
						<div id="abaMenu">
							...
							<div class="aba2">
								<a href="orcamento.jsp?id=-1">Orçamentos de Profissionais</a>
							</div>
						</div>
					<%}%>
					<div class="topContent">
						...
						<div class="textBox" id="profissionalId" style="width: 80px;">
							...
							<select id="empSaudeIdIn" name="empSaudeIdIn">
								<option value="">Selecione</option>								
								<%if (unidadeList.size() == 1) {
									for(EmpresaSaude  emp: empresaList) {
										out.print("<option value=\"" + emp.getCodigo() + 
												"\">" + emp.getCodigo() + "</option>");
									}
								}%>
							</select>
						</div>					
						<div id="empresaSaude" class="textBox" style="width: 235px;">
							<label>Empresa Saúde</label><br/>
							<input id="empresaSaudeIn" name="empresaSaudeIn" type="text" style="width: 235px;"/>
						</div>
				...
				<div id="mainContent">
					...
					<div id="dataGrid">
						...
						if (usuario == null) {
							query = sess.getNamedQuery("orcamentoEmpresaOf");
							query.setLong("codigo", 
									(unidadeList.size() == 1)? unidadeList.get(0).getCodigo() : 0);
							} else {
								query = sess.getNamedQuery("orcamentoEmpByUser");
							...
							for(Orcamento orc: orcamento) {							
								...
								empresa = (EmpresaSaude) sess.get(EmpresaSaude.class, orc.getPessoa().getCodigo());
								...
								dataGrid.addImg(Util.getIcon(parcelaList, "orcamento"));
								dataGrid.addRow();
							}
