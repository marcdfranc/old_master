...
<%@page import="com.marcsoftware.database.Login"%><html xmlns="http://www.w3.org/1999/xhtml">
	...
	transaction.commit();
	sess.close();
	MensalidadeCupom cupom = new MensalidadeCupom();
	...
	String link = Util.linkToNewPage(request, "rel_matricial/cupom_mensalidade.jsp", "splash_ok.jsp");
	%>

<head>
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
	<title>Master Cupon Mensalidade</title>
</head>
<body>
