...
<%@page import="com.marcsoftware.relmatricial.MensalidadeCupom"%>
<%@page import="org.hibernate.Session"%>
<%@page import="com.marcsoftware.utilities.HibernateUtil"%>
<%@page import="com.marcsoftware.database.Login"%>
<%@page import="org.hibernate.Query"%>
<%@page import="com.marcsoftware.relmatricial.FaturaEmpresaCupom"%><html xmlns="http://www.w3.org/1999/xhtml">
	...
	FaturaEmpresaCupom cupom = new FaturaEmpresaCupom();
	...
	cupom.setUsername(login.getUsername());
	cupom.setDinheiro(Double.parseDouble(request.getParameter("vpg")));	
	cupom.mountRel();
	String relatorio = cupom.getRelatorio();
	String link = Util.linkToNewPage(request, "rel_matricial/cupom_empresa.jsp", "splash_ok.jsp");
	sess.close();
	%>

<head>
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
	<title>Master Cupon Empresa</title>
</head>
<body>
